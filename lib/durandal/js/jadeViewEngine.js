 ...
 * @requires jquery
 */
define(['durandal/system', 'jquery', 'jade/jade'], function (system, $, jade) {
    var parseMarkup;
    ...
    return {
        ...
        createView: function(viewId) {
            ...
            return system.defer(function(dfd) {
                system.acquire(requirePath).then(function(jadeMarkup) {
                    var markup = jade.compile(jadeMarkup, {pretty : true})();
